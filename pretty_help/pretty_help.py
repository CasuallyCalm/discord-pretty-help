...
class PrettyHelp(HelpCommand):
    ...
    def get_ending_note(self):
        ...
        note = self.ending_note or (
            "Type {ctx.clean_prefix}{help.invoked_with} command for more info on a command.\n"
            "You can also type {ctx.clean_prefix}{help.invoked_with} category for more info on a category."
        )
