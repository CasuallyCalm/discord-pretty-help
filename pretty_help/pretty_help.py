...
class Paginator:
    ...
    def __init__(self, navigation, color=None, prefix="```", suffix="```", max_size=2000):
...
class PrettyHelp(HelpCommand):
    ...
    def __init__(self, **options):
        ...
        self.navigation = options.pop("navigation", {"◀️": -1, "▶️": 1, "❌": 0})
        if self.paginator is None:
            self.paginator = Paginator(self.navigation, color=options.pop("color", None))
